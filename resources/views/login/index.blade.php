...
<div class="container mx-auto bg-white rounded position-relative d-flex mt-5 warna">
	...
	<form class="mx-auto col-md-6 my-5" action="{{ route('login') }}" method="POST">
		@csrf
		<h3 class="text-center mb-5 tulisan" style="text-shadow: 4px 2px 4px rgba(91,113,135,1);">LOGIN SEBAGAI<br> PELAPOR</h3>
	  ...
	  <a href="{{ url('daftar') }}">Belum Punya Akun? Daftar Disini! &#8594;</a>
	</form>
