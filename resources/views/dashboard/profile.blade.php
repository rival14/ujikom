...
<div class="container mt-4">
	<div class="card">
	  ...
	  <div class="card-body">
	  	...
	  	<form action="{{ route('dashboard.profile') }}" method="POST" class="col-md-10 mx-auto" enctype="multipart/form-data">
	  		@csrf
	  		<input type="hidden" class="form-control" value="{{ $data->nik }}" name="nik">
		  ...
		  <div class="form-group">
			...
			<div class="card mb-3" style="width: 18rem;">
			  <img src="{{ asset('storage/masyarakat/profile') }}/{{ $data->foto_user }}" class="card-img-top" alt="Preview" id="fotoprofile">
			</div>
